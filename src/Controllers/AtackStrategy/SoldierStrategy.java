...
public class SoldierStrategy implements FightStrategy {
    public SoldierStrategy() {
    }
    ...
    public void atacar(Inimigo inimigo, Heroi heroi) throws InterruptedException {
        ...
        Thread.sleep(1000);
        System.out.println("Porque o " + heroi.getNome() + " é da class Soldier tem menos proteção e leva 10% mais dano.\n");
        Thread.sleep(1000);
        int opcao = 0;
    ...
    public void ataqueNormal(Inimigo inimigo, Heroi heroi) {
        ...
        System.out.println(heroi.getNome() + " descarrega um carregador no " + inimigo.getNome() + " e dá " + textoVermelho + damage + " damage." + pararCor);
    ...
    public void ataqueEspecial(Inimigo inimigo, Heroi heroi) throws InterruptedException {
        ...
        System.out.println(heroi.getNome() + " carrega a sua arma com balas explosivas!");
        if (random == 1) {
            damage += 5;
            System.out.println("O " + heroi.getNome() + " acertou diretamente no " + inimigo.getNome() + " o ataque foi critico!");
        }
