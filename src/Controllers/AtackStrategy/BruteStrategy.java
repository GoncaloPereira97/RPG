...
public class BruteStrategy implements FightStrategy {
    ...
    public void atacar(Inimigo inimigo, Heroi heroi) throws InterruptedException {
        ...
        Thread.sleep(1000);
        System.out.println("Porque o " + heroi.getNome() + " é da class Brute o inimigo perde 80% do seu primary stat.\n");
        Thread.sleep(1000);
    ...
    public void ataqueNormal(Inimigo inimigo, Heroi heroi) {
        ...
        System.out.println(heroi.getNome() + " dá uma marretada no " + inimigo.getNome() + " e dá " + textoVermelho + damage + " damage." + pararCor);
    ...
    public void ataqueEspecial(Inimigo inimigo, Heroi heroi) throws InterruptedException {
        ...
        System.out.print("O teu ataque especial deu " + textoVermelho + damageTotal + pararCor + " damage e deixou o inimigo com ");
        inimigo.levarDMG(damageTotal);
        System.out.println(inimigo.getNome() + " ficou com " + textoVermelho + inimigo.getHP() + " HP" + pararCor);
    }
