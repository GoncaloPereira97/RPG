...
public class TechieStrategy implements FightStrategy{
    public TechieStrategy() {
    }
    ...
    public void ataqueNormal(Inimigo inimigo, Heroi heroi) {
        ...
        System.out.println(heroi.getNome() + " dispara um raio elétrico contra " + inimigo.getNome() + " e dá " + damage + " damage.");
    ...
    public void ataqueEspecial(Inimigo inimigo, Heroi heroi) throws InterruptedException {
        ...
        System.out.println(heroi.getNome() + " carrega o seu " + heroi.getPrimaryWeapon().getNome() + " com toda a energia e dá um soco no " + inimigo.getNome());
        if (random == 1){
            damage += 5;
            System.out.println(heroi.getPrimaryWeapon().getNome() + " ficou overchanged e o ataque foi critico!");
        }
